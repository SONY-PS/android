...
public class MainActivity extends AppCompatActivity {
    EditText editText;
    Button b1, b2, b3, b4, b5, b6, b7, b8, b9, b0,bpt, plus, sub, mul, div, equal, ac;
    float value1, value2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bpt = findViewById(R.id.button12);
        plus = findViewById(R.id.button13);
